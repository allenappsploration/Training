...
public class TutorialImageView extends Fragment {
	...
	public static TutorialImageView newInstance() {
		TutorialImageView f = new TutorialImageView();
		return f;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View root = inflater.inflate(R.layout.tutorial_imageview, container, false);
