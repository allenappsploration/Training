...
public class LazyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        pubDate.setText(song.get(MainActivity.KEY_PUBDATE));
        hidURL.setText(song.get(MainActivity.KEY_LINK));
        imageLoader.DisplayImage(song.get(MainActivity.KEY_THUMBNAIL), thumb_image);
        return vi;
    }
}