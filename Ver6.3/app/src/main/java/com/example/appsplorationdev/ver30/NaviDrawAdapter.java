 ...
 */
public class NaviDrawAdapter extends BaseAdapter {

    private Activity activity;
    private ArrayList<HashMap<String, String>> data;
    private static LayoutInflater inflater = null;

    public NaviDrawAdapter (Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data = d;
    ...
    public View getView (int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            ...
            id.setText(itemList.get(MainActivity.KEY_ID));
            name.setText(itemList.get(MainActivity.KEY_NAME));
